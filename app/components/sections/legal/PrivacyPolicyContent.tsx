...
export default function PrivacyPolicyContent() {
  ...
  const renderContentBlock = (block: any, index: number) => {
    switch (block.type) {
      ...
      case 'important':
        return (
          <div key={index} className="bg-electric-blue/10 border border-electric-blue/30 rounded-lg p-6 mb-6">
            <div className="flex items-start">
              <AlertCircle className="w-6 h-6 text-electric-blue mr-3 flex-shrink-0 mt-0.5" />
              <div className="flex-1">
                <p className="text-text-primary leading-relaxed font-medium">{block.text}</p>
              </div>
            </div>
          </div>
        );
        ...
        <Container>
          ...
          >
            ...
            <p className="text-xl text-text-secondary mb-8 leading-relaxed">
              ...
              in compliance with GDPR and US privacy laws.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4 text-sm text-text-secondary">
              <div className="flex items-center">
                <Lock className="w-4 h-4 mr-2 text-electric-blue" />
                GDPR Compliant
              </div>
              <div className="flex items-center">
                <Eye className="w-4 h-4 mr-2 text-electric-blue" />
                Transparent
              </div>
              <div className="flex items-center">
            ...
            >
              <div className="lg:sticky lg:top-24 bg-[#0F1729] rounded-xl p-6 border border-slate-gray/20">
                ...
                <div className="mt-6 pt-6 border-t border-slate-gray/20">
                  <h4 className="text-sm font-semibold text-text-primary mb-3">Questions?</h4>
                  <a
              ...
              <div className="mt-12 bg-gradient-to-r from-electric-blue/10 to-accent-hover/10 rounded-xl p-8 border border-electric-blue/30">
                <div className="text-center">
                  ...
                  <p className="text-text-secondary mb-6 max-w-2xl mx-auto">
                    We're here to help. If you have any questions about our privacy practices or
      ...
      <section className="relative py-8 border-t border-slate-gray/20">
        <Container>
          <div className="text-center text-sm text-text-secondary">
            <p>
              This policy is effective as of {privacyPolicyContent.effectiveDate}.{' '}
              <button
